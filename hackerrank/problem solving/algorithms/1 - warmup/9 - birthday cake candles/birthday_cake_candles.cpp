...
int birthday_cake_candles(vector<int> candles) {
    int element_max {*max_element(candles.begin(), candles.end())};
    int count_max_element {count(candles.begin(), candles.end(), element_max)};
...
int main()
{
    ...
    int result = birthday_cake_candles(candles);
