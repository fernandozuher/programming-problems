...
def calculatePotentialKaprekarNumber(NUMBER):
    ...
    LEFT_NUMBER_IN_STRING = getLeftNumberInString(SQUARE_NUMBER_IN_STRING, LENGTH_OF_NUMBER_IN_STRING)
    RIGHT_NUMBER_IN_STRING = getRightNumberInString(SQUARE_NUMBER_IN_STRING, LENGTH_OF_NUMBER_IN_STRING)
...
def getLeftNumberInString(SQUARE_NUMBER_IN_STRING, LENGTH_OF_NUMBER_IN_STRING):
...
def getRightNumberInString(SQUARE_NUMBER_IN_STRING, LENGTH_OF_NUMBER_IN_STRING):
