...
long calculate_minimum_cost_of_buying_gifts(const gifts *const x);
    bool are_original_costs_cheaper_or_equal_than_conversion_between_gifts(const gifts *const x);
...
int main()
{
    ...
    long calculate_minimum_cost_of_buying_gifts(const gifts *const x)
    {
        if (are_original_costs_cheaper_or_equal_than_conversion_between_gifts(x))
