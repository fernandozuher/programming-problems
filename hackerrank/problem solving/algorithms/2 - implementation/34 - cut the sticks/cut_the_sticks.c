...
int main() {
    ...
    int** cut_the_sticks(int* array, const int SIZE) {
        ...
        int** remaining_sticks_of_each_iteration = initialize_result(SIZE);
        ...
        for (int i = 0; i < SIZE; result_size++) {
            ...
            remaining_sticks_of_each_iteration[0][result_size] = CURRENT_ITERATION_SIZE;
        ...
        int** initialize_result(const int SIZE) {
            ...
            remaining_sticks_of_each_iteration[0] = (int*) calloc(SIZE, sizeof(int));
            remaining_sticks_of_each_iteration[1] = (int*) calloc(1, sizeof(int));
            remaining_sticks_of_each_iteration[0][0] = SIZE;
