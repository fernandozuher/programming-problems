...
int count_fruits_on_house(int s, int t, int tree_location, vector<int> fruits) {
    auto verify_fruit_location = [s, t, tree_location] (int partial_location) {
...
void count_apples_and_oranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
    int apples_on_house {count_fruits_on_house(s, t, a, apples)};
    int oranges_on_house {count_fruits_on_house(s, t, b, oranges)};
